...
const ANIMALS_SEED = [
  ...
  //  JUŽNÁ AMERIKA
  // ═══════════════════════════════════════
  { name:"Jaguar", label:"Jaguár americký", continent:"Južná Amerika", sciName:"Panthera onca",
    fact:"Jaguár americký má najsilnejší hryz spomedzi všetkých veľkých mačiek a dokáže prehrýzť aj korytnačí pancier.",
    falseFacts:["Jaguár americký je poddruh leoparda.","Jaguár americký žije výhradne v Afrike.","Jaguár americký je najrýchlejšia mačka na svete."] },
  { name:"Anaconda", label:"Anakonda veľká", continent:"Južná Amerika", sciName:"Eunectes murinus",
    fact:"Anakonda veľká je najťažší had na svete – môže vážiť cez 200 kg a merať viac ako 7 metrov.",
    falseFacts:["Anakonda veľká je jedovatý had.","Anakonda veľká je najdlhší had na svete.","Anakonda veľká žije na stromoch a nikdy nevstupuje do vody."] },
  { name:"Capybara", label:"Kapybara", continent:"Južná Amerika", sciName:"Hydrochoerus hydrochaeris",
    fact:"Kapybara je najväčší hlodavec na svete – váži až 65 kg a žije v skupinách pri vode.",
    falseFacts:["Kapybara je malý hlodavec veľkosti králika.","Kapybara žije samotársky v púšťach.","Kapybara je mäsožravec."] },
  { name:"Llama", label:"Lama", continent:"Južná Amerika", sciName:"Lama glama",
    fact:"Lama je domestikované zviera z Ánd, ktoré slúži ako nosné zviera a pri podráždení pľuje.",
    falseFacts:["Lama je divoké zviera, ktoré nebolo nikdy domestikované.","Lama pochádza z Afriky.","Lama je príbuzná koňom."] },
  { name:"Alpaca", label:"Alpaka", continent:"Južná Amerika", sciName:"Vicugna pacos",
    fact:"Alpaka sa chová pre svoju jemnú vlnu, ktorá je teplejšia a ľahšia ako ovčia vlna.",
    falseFacts:["Alpaka je divoké zviera žijúce v pralesoch.","Alpaka a lama sú ten istý druh.","Alpaka je mäsožravec."] },
  { name:"Vicuña", label:"Vikuňa", continent:"Južná Amerika", sciName:"Vicugna vicugna",
    fact:"Vikuňa má najjemnejšiu srsť spomedzi všetkých zvierat a jej vlna je drahšia ako kašmír.",
    falseFacts:["Vikuňa je domestikované zviera bežne chované na farmách.","Vikuňa žije v nížinných pralesoch.","Vikuňa je príbuzná jeleňom."] },
  { name:"Giant anteater", label:"Mravčiar veľký", continent:"Južná Amerika", sciName:"Myrmecophaga tridactyla",
    fact:"Mravčiar veľký má jazyk dlhý až 60 cm a dokáže ho vysunúť a zatiahnuť až 150-krát za minútu.",
    falseFacts:["Mravčiar veľký má krátky jazyk a mravce chytá labkami.","Mravčiar veľký sa živí ovocím a lístím.","Mravčiar veľký je malé zviera veľkosti mačky."] },
  { name:"Giant armadillo", label:"Pásavec veľký", continent:"Južná Amerika", sciName:"Priodontes maximus",
    fact:"Pásavec veľký je najväčší pásavec na svete – váži až 50 kg a má asi 100 zubov, najviac spomedzi suchozemských cicavcov.",
    falseFacts:["Pásavec veľký nemá zuby.","Pásavec veľký sa stočí do gule ako ježko.","Pásavec veľký žije v Severnej Amerike."] },
  { name:"Sloth", label:"Leňochod trojprstý", continent:"Južná Amerika", sciName:"Bradypus variegatus",
    fact:"Leňochod trojprstý je taký pomalý, že v jeho srsti rastú riasy, ktoré mu slúžia ako maskovanie.",
    falseFacts:["Leňochod trojprstý je rýchle zviera, ktoré uteká pred predátormi.","Leňochod trojprstý žije na zemi a neliezie na stromy.","Leňochod trojprstý sa živí hmyzom."] },
  { name:"Howler monkey", label:"Revúň", continent:"Južná Amerika", sciName:"Alouatta spp.",
    fact:"Revúň je najhlasnejšie suchozemské zviera – jeho rev je počuť na vzdialenosť až 5 km.",
    falseFacts:["Revúň je tichá opica komunikujúca výhradne gestami.","Revúň žije na zemi a neliezie na stromy.","Revúň sa živí výhradne hmyzom."] },
  { name:"Spider monkey", label:"Opica pavúčia", continent:"Južná Amerika", sciName:"Ateles spp.",
    fact:"Opica pavúčia má chápavý chvost tak silný, že unesie celú váhu jej tela – funguje ako piata končatina.",
    falseFacts:["Opica pavúčia nemá chvost.","Opica pavúčia žije na zemi ako pavián.","Opica pavúčia sa živí rybami."] },
  { name:"Golden lion tamarin", label:"Leví tamarín zlatý", continent:"Južná Amerika", sciName:"Leontopithecus rosalia",
    fact:"Leví tamarín zlatý má nápadnú zlatú hrivu a žije len v úzkom páse atlantického pralesa v Brazílii.",
    falseFacts:["Leví tamarín zlatý žije po celej Južnej Amerike.","Leví tamarín zlatý je veľká opica vážiaca cez 10 kg.","Leví tamarín zlatý je príbuzný levom."] },
  { name:"Poison dart frog", label:"Pralesníčka", continent:"Južná Amerika", sciName:"Dendrobatidae spp.",
    fact:"Pralesníčka je jednou z najjedovatejších žiab na svete – jeden druh obsahuje dosť jedu na usmrtenie 10 ľudí.",
    falseFacts:["Pralesníčka je neškodná žaba bez jedu.","Pralesníčka je veľká žaba veľkosti pästi.","Pralesníčka žije vo vode a nikdy nevyliezá na súš."] },
  { name:"Toucan", label:"Tukan veľkozobý", continent:"Južná Amerika", sciName:"Ramphastos toco",
    fact:"Tukan veľkozobý má zobák dlhý až 20 cm, ktorý je dutý a ľahký a slúži na reguláciu telesnej teploty.",
    falseFacts:["Tukan veľkozobý má ťažký masívny zobák.","Tukan veľkozobý používa zobák na lov rýb.","Tukan veľkozobý žije v Afrike."] },
  { name:"Scarlet macaw", label:"Ara arakanga", continent:"Južná Amerika", sciName:"Ara macao",
    fact:"Ara arakanga sa dožíva až 75 rokov a páry si zostávajú verné celý život.",
    falseFacts:["Ara arakanga sa dožíva maximálne 5 rokov.","Ara arakanga je samotársky vták.","Ara arakanga nedokáže lietať."] },
  { name:"Hyacinth macaw", label:"Ara hyacintová", continent:"Južná Amerika", sciName:"Anodorhynchus hyacinthinus",
    fact:"Ara hyacintová je najväčší papagáj na svete s rozpätím krídel cez 1,2 metra a sýto modrou farbou.",
    falseFacts:["Ara hyacintová je malý papagáj veľkosti vrabca.","Ara hyacintová je zelená ako väčšina papagájov.","Ara hyacintová je bežný a hojný druh."] },
  { name:"Harpy eagle", label:"Harpya veľká", continent:"Južná Amerika", sciName:"Harpia harpyja",
    fact:"Harpya veľká je najsilnejší orol na svete – jej pazúry sú dlhé ako pazúry medveďa grizly.",
    falseFacts:["Harpya veľká je malý dravec veľkosti jastraba.","Harpya veľká sa živí rybami.","Harpya veľká žije v otvorených pláňach."] },
  { name:"Andean condor", label:"Kondor andský", continent:"Južná Amerika", sciName:"Vultur gryphus",
    fact:"Kondor andský má rozpätie krídel cez 3 metre a je jedným z najväčších lietajúcich vtákov na svete.",
    falseFacts:["Kondor andský je malý dravec.","Kondor andský loví živú korisť.","Kondor andský žije v nížinných pralesoch."] },
  { name:"Piranha", label:"Piraňa", continent:"Južná Amerika", sciName:"Pygocentrus nattereri",
    fact:"Piraňa červenobruchá loví v skupinách a dokáže prehrýzť oceľový rybársky vlasec.",
    falseFacts:["Piraňa je neškodná ryba živiaca sa riasami.","Piraňa žije samotársky.","Piraňa žije v morskej vode."] },
  { name:"Electric eel", label:"Úhor elektrický", continent:"Južná Amerika", sciName:"Electrophorus electricus",
    fact:"Úhor elektrický dokáže vyprodukovať elektrický výboj až 860 voltov na omráčenie koristi.",
    falseFacts:["Úhor elektrický produkuje maximálne 5 voltov.","Úhor elektrický je skutočný úhor.","Úhor elektrický žije v moriach."] },
  { name:"Caiman", label:"Kajman čierny", continent:"Južná Amerika", sciName:"Melanosuchus niger",
    fact:"Kajman čierny je najväčší predátor Amazónie – dorasta do dĺžky 5 metrov.",
    falseFacts:["Kajman čierny je malý plaz dlhý maximálne 1 meter.","Kajman čierny žije v Afrike.","Kajman čierny sa živí výhradne rybami."] },
  { name:"Ocelot", label:"Ocelot", continent:"Južná Amerika", sciName:"Leopardus pardalis",
    fact:"Ocelot je nočná mačkovitá šelma s krásnou škvrnitou srsťou a výborným nočným videním.",
    falseFacts:["Ocelot je veľká mačka vážiaca cez 100 kg.","Ocelot žije v otvorených stepiach.","Ocelot nemá škvrny – má jednofarebné sfarbenie."] },
  { name:"Maned wolf", label:"Vlk hrivnatý", continent:"Južná Amerika", sciName:"Chrysocyon brachyurus",
    fact:"Vlk hrivnatý vyzerá ako líška na chodúľoch – má dlhé nohy prispôsobené na pohyb v vysokej tráve.",
    falseFacts:["Vlk hrivnatý je skutočný vlk príbuzný vlkovi sivému.","Vlk hrivnatý žije v arktických oblastiach.","Vlk hrivnatý je veľké zviera vážiace cez 80 kg."] },
  { name:"Spectacled bear", label:"Medveď okuliarnatý", continent:"Južná Amerika", sciName:"Tremarctos ornatus",
    fact:"Medveď okuliarnatý je jediný medveď v Južnej Amerike a má charakteristické svetlé kruhy okolo očí.",
    falseFacts:["Medveď okuliarnatý žije v Severnej Amerike.","Medveď okuliarnatý nemá žiadne zvláštne znaky na tvári.","Medveď okuliarnatý je najväčší medveď na svete."] },
  { name:"Tapir", label:"Tapír juhoamerický", continent:"Južná Amerika", sciName:"Tapirus terrestris",
    fact:"Tapír juhoamerický má pohyblivý rypák podobný krátkemu chobotu, ktorým trhá listy a plody.",
    falseFacts:["Tapír juhoamerický je príbuzný slonovi.","Tapír juhoamerický je mäsožravec.","Tapír juhoamerický žije výhradne v Ázii."] },
  { name:"Chinchilla", label:"Činčila", continent:"Južná Amerika", sciName:"Chinchilla lanigera",
    fact:"Činčila má najhustejšiu srsť spomedzi suchozemských zvierat – z jedného folikulu rastie až 60 chlpov.",
    falseFacts:["Činčila má riedku srsť ako potkan.","Činčila pochádza z Afriky.","Činčila sa kúpe vo vode."] },
  { name:"Capuchin monkey", label:"Kapucín", continent:"Južná Amerika", sciName:"Cebus spp.",
    fact:"Kapucín je jedna z najinteligentnejších opíc Nového sveta – používa kamene na rozbíjanie orechov.",
    falseFacts:["Kapucín je hlúpa opica neschopná používania nástrojov.","Kapucín žije v Ázii.","Kapucín je veľká opica vážiaca cez 20 kg."] },
  { name:"Red-eyed tree frog", label:"Rosníčka červenooká", continent:"Južná Amerika", sciName:"Agalychnis callidryas",
    fact:"Rosníčka červenooká má výrazné červené oči, ktoré pri prebudení vyplašia predátorov – stratégia zvaná stroboskopické sfarbenie.",
    falseFacts:["Rosníčka červenooká je jedovatá.","Rosníčka červenooká má nevýrazné hnedé sfarbenie.","Rosníčka červenooká žije vo vode celý život."] },
  { name:"Galapagos tortoise", label:"Korytnačka galapágska", continent:"Južná Amerika", sciName:"Chelonoidis nigra",
    fact:"Korytnačka galapágska sa dožíva viac ako 100 rokov a je najväčšia suchozemská korytnačka na svete.",
    falseFacts:["Korytnačka galapágska sa dožíva maximálne 20 rokov.","Korytnačka galapágska je malá korytnačka veľkosti dlane.","Korytnačka galapágska žije vo vode."] },
  { name:"Marine iguana", label:"Leguán morský", continent:"Južná Amerika", sciName:"Amblyrhynchus cristatus",
    fact:"Leguán morský z Galapág je jediný jašter na svete, ktorý sa potápa do mora a živí sa morskými riasami.",
    falseFacts:["Leguán morský sa živí rybami.","Leguán morský žije výhradne na súši.","Leguán morský žije v Karibiku."] },
  { name:"Hoatzin", label:"Hoatzín", continent:"Južná Amerika", sciName:"Opisthocomus hoazin",
    fact:"Hoatzín je jediný vták na svete, ktorý trávi potravu fermentáciou ako kravy, a preto zapácha.",
    falseFacts:["Hoatzín je dravý vták loviaci ryby.","Hoatzín je bežný domáci vták chovaný pre mäso.","Hoatzín žije v Afrike."] },
  { name:"Potoo", label:"Lelek veľkozraký", continent:"Južná Amerika", sciName:"Nyctibius grandis",
    fact:"Lelek veľkozraký cez deň nehybne sedí na konári a vyzerá presne ako kus zlomeného dreva.",
    falseFacts:["Lelek veľkozraký je farebný vták ľahko viditeľný v lese.","Lelek veľkozraký je aktívny cez deň.","Lelek veľkozraký sa živí ovocím."] },
  { name:"Coati", label:"Koati červený", continent:"Južná Amerika", sciName:"Nasua nasua",
    fact:"Koati červený má dlhý pohyblivý nos a dlhý pruhovaný chvost, ktorý drží pri chôdzi vzpriamený ako anténu.",
    falseFacts:["Koati červený je príbuzný mačkám.","Koati červený žije samotársky.","Koati červený je nočné zviera."] },
  { name:"Bush dog", label:"Pes pralesný", continent:"Južná Amerika", sciName:"Speothos venaticus",
    fact:"Pes pralesný je malý pes žijúci v skupinách a lovící korisť oveľa väčšiu ako on sám, vrátane tapírov.",
    falseFacts:["Pes pralesný je veľký pes veľkosti vlka.","Pes pralesný žije samotársky.","Pes pralesný sa živí výhradne ovocím."] },
  { name:"Giant otter", label:"Vydra obrovská", continent:"Južná Amerika", sciName:"Pteronura brasiliensis",
    fact:"Vydra obrovská dorasta do dĺžky 1,8 metra a loví v rodinných skupinách, ktoré dokážu zahnať aj kajmanov.",
    falseFacts:["Vydra obrovská je malé zviera veľkosti mačky.","Vydra obrovská žije samotársky.","Vydra obrovská sa živí rastlinami."] },
  { name:"Amazonian river dolphin", label:"Delfín ružový", continent:"Južná Amerika", sciName:"Inia geoffrensis",
    fact:"Delfín ružový žije v rieke Amazonke a má ružovú farbu, ktorá sa zintenzívňuje pri vzrušení.",
