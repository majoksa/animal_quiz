...
const ANIMALS_SEED = [
  ...
  //  AUSTRÁLIA A OCEÁNIA
  // ═══════════════════════════════════════
  { name:"Kangaroo", label:"Klokan červený", continent:"Austrália", sciName:"Macropus rufus",
    fact:"Klokan červený je najväčší vačkovec na svete – samce dorástajú do výšky 1,8 metra a dokážu skákať rýchlosťou 56 km/h.",
    falseFacts:["Klokan červený je malé zviera veľkosti zajaca.","Klokan červený nedokáže skákať – chodí po štyroch.","Klokan červený je placentárny cicavec."] },
  { name:"Koala", label:"Koala", continent:"Austrália", sciName:"Phascolarctos cinereus",
    fact:"Koala spí až 22 hodín denne a živí sa výhradne listami eukalyptu, ktoré sú pre väčšinu zvierat jedovaté.",
    falseFacts:["Koala je medveď.","Koala sa živí hmyzom a mäsom.","Koala spí len 4 hodiny denne."] },
  { name:"Platypus", label:"Vtákopysk podivný", continent:"Austrália", sciName:"Ornithorhynchus anatinus",
    fact:"Vtákopysk podivný je jedným z mála cicavcov, ktorí znášajú vajcia, a samce majú jedovatý osteň na zadných nohách.",
    falseFacts:["Vtákopysk podivný je vták.","Vtákopysk podivný rodí živé mláďatá.","Vtákopysk podivný nie je jedovatý."] },
  { name:"Echidna", label:"Ježura austrálska", continent:"Austrália", sciName:"Tachyglossus aculeatus",
    fact:"Ježura austrálska je pokrytá bodlinami a spolu s vtákopyskom je jediným cicavcom na svete, ktorý znáša vajcia.",
    falseFacts:["Ježura austrálska rodí živé mláďatá.","Ježura austrálska je príbuzná ježkom.","Ježura austrálska žije vo vode."] },
  { name:"Wombat", label:"Vombat", continent:"Austrália", sciName:"Vombatus ursinus",
    fact:"Vombat produkuje kockový trus – jediný živočích na svete, ktorého výkaly majú kockový tvar.",
    falseFacts:["Vombat žije na stromoch.","Vombat je mäsožravec.","Vombat pochádza z Južnej Ameriky."] },
  { name:"Tasmanian devil", label:"Diabol tasmánsky", continent:"Austrália", sciName:"Sarcophilus harrisii",
  ...
  { name:"Kookaburra", label:"Kukabura obrovská", continent:"Austrália", sciName:"Dacelo novaeguineae",
    ...
    falseFacts:["Kukabura obrovská je tichý vták.","Kukabura obrovská žije v Južnej Amerike.","Kukabura obrovská sa živí rybami."] },
  { name:"Emu", label:"Emu hnedý", continent:"Austrália", sciName:"Dromaius novaehollandiae",
    fact:"Emu hnedý je druhý najväčší vták na svete a samec sedí na vajciach 8 týždňov bez jedenia a pitia.",
    falseFacts:["Emu hnedý je malý vták veľkosti kury.","Emu hnedý dokáže lietať.","Emu hnedý žije v Afrike."] },
  { name:"Cassowary", label:"Kazuár prilbový", continent:"Austrália", sciName:"Casuarius casuarius",
    fact:"Kazuár prilbový je považovaný za najnebezpečnejšieho vtáka na svete – jeho pazúr na nohe je dlhý až 12 cm.",
    falseFacts:["Kazuár prilbový je neškodný vták.","Kazuár prilbový dokáže lietať.","Kazuár prilbový je malý vták."] },
  { name:"Lyrebird", label:"Lyrovček nádherný", continent:"Austrália", sciName:"Menura novaehollandiae",
    fact:"Lyrovček nádherný dokáže dokonale napodobniť takmer akýkoľvek zvuk – od motorovej píly po fotoaparát.",
    falseFacts:["Lyrovček nádherný je nemý vták.","Lyrovček nádherný žije v Ázii.","Lyrovček nádherný sa živí rybami."] },
  { name:"Frilled-neck lizard", label:"Jašter goliernatý", continent:"Austrália", sciName:"Chlamydosaurus kingii",
    fact:"Jašter goliernatý má okolo krku veľký kožený golier, ktorý roztvorí na zastrašenie predátorov.",
    falseFacts:["Jašter goliernatý je jedovatý.","Jašter goliernatý je veľký plaz dlhý cez 2 metre.","Jašter goliernatý žije vo vode."] },
  ...
  { name:"Sugar glider", label:"Vakoveverička lietavá", continent:"Austrália", sciName:"Petaurus breviceps",
    fact:"Vakoveverička lietavá má kožnú membránu medzi prednými a zadnými nohami, vďaka ktorej dokáže plachtiť až 50 metrov.",
    falseFacts:["Vakoveverička lietavá je hlodavec.","Vakoveverička lietavá dokáže aktívne lietať ako vták.","Vakoveverička lietavá žije na zemi."] },
  { name:"Bilby", label:"Bandikut králičí", continent:"Austrália", sciName:"Macrotis lagotis",
    fact:"Bandikut králičí má veľké uši a dlhý rypák a v Austrálii nahrádza veľkonočného zajačika.",
    falseFacts:["Bandikut králičí je príbuzný zajacovi.","Bandikut králičí žije v Ázii.","Bandikut králičí je mäsožravec."] },
  { name:"Dingo", label:"Pes dingo", continent:"Austrália", sciName:"Canis lupus dingo",
    fact:"Pes dingo je austrálsky divoký pes, ktorý na kontinent prišiel pred asi 4000 rokmi a nedokáže štekať – iba výva.",
    falseFacts:["Pes dingo je pôvodný austrálsky druh.","Pes dingo šteká ako domáci pes.","Pes dingo je mačkovitá šelma."] },
  { name:"Quoll", label:"Kunovček", continent:"Austrália", sciName:"Dasyurus spp.",
    fact:"Kunovček je škvrnitý vačkový predátor, ktorý je jedným z mála vačkovcov s účinným loveckým inštinktom.",
    falseFacts:["Kunovček je bylinožravec.","Kunovček žije v Európe.","Kunovček je hlodavec."] },
  { name:"Kiwi", label:"Kivi severný", continent:"Austrália", sciName:"Apteryx mantelli",
    fact:"Kivi severný je nelietavý vták z Nového Zélandu s hmatovými fúzikmi a čuchom na špičke zobáka – jediný vták s nozdrami na konci zobáka.",
    falseFacts:["Kivi severný dokáže lietať.","Kivi severný žije v Austrálii.","Kivi severný je veľký vták."] },
  { name:"Tuatara", label:"Hatéria bodkovaná", continent:"Austrália", sciName:"Sphenodon punctatus",
    fact:"Hatéria bodkovaná z Nového Zélandu je živá fosília – je jediným prežívajúcim členom radu, ktorý existoval v dobe dinosaurov.",
    falseFacts:["Hatéria bodkovaná je jašterica.","Hatéria bodkovaná žije v Austrálii.","Hatéria bodkovaná sa rozmnožuje každý rok."] },
  { name:"Kakapo", label:"Kakapo sovie", continent:"Austrália", sciName:"Strigops habroptilus",
    fact:"Kakapo sovie je jediný nelietavý papagáj na svete a je kriticky ohrozený – existuje len asi 250 jedincov.",
    falseFacts:["Kakapo sovie dokáže lietať.","Kakapo sovie žije v Austrálii.","Kakapo sovie je bežný a hojný druh."] },
  { name:"Takahe", label:"Takahe", continent:"Austrália", sciName:"Porphyrio hochstetteri",
    fact:"Takahe je nelietavý vták z Nového Zélandu, ktorý bol považovaný za vyhynutý, kým nebol v roku 1948 znovuobjavený.",
    falseFacts:["Takahe dokáže lietať.","Takahe je malý vták veľkosti vrabca.","Takahe žije v Austrálii."] },
  { name:"Weta", label:"Weta obrovská", continent:"Austrália", sciName:"Deinacrida heteracantha",
    fact:"Weta obrovská z Nového Zélandu je jeden z najťažších hmyzov na svete – váži až 70 gramov, viac ako vrabec.",
    falseFacts:["Weta obrovská je malý hmyz.","Weta obrovská žije v Austrálii.","Weta obrovská je jedovatá."] },
  { name:"Cockatoo", label:"Kakadu biely", continent:"Austrália", sciName:"Cacatua alba",
    fact:"Kakadu biely je inteligentný papagáj so zdvíhateľnou chochlatou, ktorý sa dožíva až 70 rokov.",
    falseFacts:["Kakadu biely sa dožíva maximálne 5 rokov.","Kakadu biely je tichý vták.","Kakadu biely žije v Južnej Amerike."] },
  { name:"Box jellyfish", label:"Krabicová medúza", continent:"Austrália", sciName:"Chironex fleckeri",
    fact:"Krabicová medúza z austrálskych vôd je najjedovatejší morský živočích – jej jed dokáže zabiť človeka za pár minút.",
    falseFacts:["Krabicová medúza je neškodná.","Krabicová medúza žije v sladkej vode.","Krabicová medúza nemá žiadne chápadlá."] },
  { name:"Blue-ringed octopus", label:"Chobotnica modroplášťová", continent:"Austrália", sciName:"Hapalochlaena maculosa",
    fact:"Chobotnica modroplášťová je veľká len ako loptička na golf, ale jej jed je dosť silný na usmrtenie 26 dospelých ľudí.",
    falseFacts:["Chobotnica modroplášťová je nejedovatá.","Chobotnica modroplášťová je veľká chobotnica.","Chobotnica modroplášťová žije v hlbokom mori."] },
  { name:"Platypus frog", label:"Žaba nosatá", continent:"Austrália", sciName:"Rheobatrachus spp.",
    fact:"Žaba nosatá (dnes vyhynutá) bola jediným živočíchom, u ktorého samice prehltli oplodnené vajcia a mláďatá sa vyliahli v žalúdku.",
    falseFacts:["Žaba nosatá stále žije v austrálskych riekach.","Žaba nosatá je jedovatá žaba.","Žaba nosatá je najväčšia žaba na svete."] },

  //  ANTARKTÍDA
  // ═══════════════════════════════════════
  { name:"Emperor penguin", label:"Tučniak cisársky", continent:"Antarktída", sciName:"Aptenodytes forsteri",
    fact:"Tučniak cisársky je najväčší tučniak na svete a samec inkubuje vajce na nohách 65 dní v teplote -60 °C.",
    falseFacts:["Tučniak cisársky dokáže lietať.","Tučniak cisársky žije v Arktíde.","Tučniak cisársky je malý tučniak."] },
  { name:"Adelie penguin", label:"Tučniak kroužkový", continent:"Antarktída", sciName:"Pygoscelis adeliae",
    fact:"Tučniak kroužkový nosí kamienky ako darčeky partnerke pri namlouvacích rituáloch.",
    falseFacts:["Tučniak kroužkový žije v lese.","Tučniak kroužkový dokáže lietať.","Tučniak kroužkový sa živí rastlinami."] },
  { name:"Leopard seal", label:"Tuleň leopardí", continent:"Antarktída", sciName:"Hydrurga leptonyx",
    fact:"Tuleň leopardí je najväčší predátor Antarktídy – loví tučniaky a iné tulene a dorasta do dĺžky 3,5 metra.",
    falseFacts:["Tuleň leopardí sa živí len rybami.","Tuleň leopardí žije v Arktíde.","Tuleň leopardí je malý tuleň."] },
  { name:"Wandering albatross", label:"Albatros sťahovavý", continent:"Antarktída", sciName:"Diomedea exulans",
    fact:"Albatros sťahovavý má najväčšie rozpätie krídel spomedzi všetkých vtákov – až 3,5 metra.",
    falseFacts:["Albatros sťahovavý je malý morský vták.","Albatros sťahovavý žije v lese.","Albatros sťahovavý nedokáže lietať."] },
  { name:"Antarctic krill", label:"Kril antarktický", continent:"Antarktída", sciName:"Euphausia superba",
    fact:"Kril antarktický tvorí biomasu asi 500 miliónov ton a je základom potravinového reťazca celej Antarktídy.",
    falseFacts:["Kril antarktický je veľký kôrovec.","Kril antarktický žije v tropických moriach.","Kril antarktický sa živí rybami."] },
  { name:"Weddell seal", label:"Tuleň Weddellov", continent:"Antarktída", sciName:"Leptonychotes weddellii",
    fact:"Tuleň Weddellov žije najbližšie k južnému pólu spomedzi všetkých cicavcov a potápa sa do hĺbky 600 metrov.",
    falseFacts:["Tuleň Weddellov žije v Arktíde.","Tuleň Weddellov nepláva – žije len na ľade.","Tuleň Weddellov je mäsožravec žijúci na súši."] },
  { name:"South polar skua", label:"Pomorník južný", continent:"Antarktída", sciName:"Stercorarius maccormicki",
    fact:"Pomorník južný je agresívny dravý vták, ktorý kradne jedlo iným vtákom a napáda aj ľudí pri hniezdach.",
    falseFacts:["Pomorník južný je krotký a plachý vták.","Pomorník južný sa živí len rybami.","Pomorník južný žije v tropických oblastiach."] },
  { name:"Antarctic fur seal", label:"Lachtaň antarktický", continent:"Antarktída", sciName:"Arctocephalus gazella",
    fact:"Lachtaň antarktický bol pre kožušinový obchod takmer vyhubený, ale po ochranných opatreniach sa populácia obnovila na milióny.",
    falseFacts:["Lachtaň antarktický bol vždy hojný.","Lachtaň antarktický žije v Arktíde.","Lachtaň antarktický sa živí rastlinami."] },
  { name:"Snow petrel", label:"Búrlivák snežný", continent:"Antarktída", sciName:"Pagodroma nivea",
    fact:"Búrlivák snežný je čisto biely vták hniezdiac na skalách uprostred Antarktídy – bol zaznamenaný aj 440 km od pobrežia.",
