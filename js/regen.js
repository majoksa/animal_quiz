...
const Regen = (() => {
  ...
  /* ── Slovak animal name map (hardcoded fallback) ── */
  const NAME_SK = {
    // AFRICA
    'Lion': 'Lev', 'African elephant': 'Africký slon', 'Giraffe': 'Žirafa',
    'Plains zebra': 'Zebra stepná', 'Hippopotamus': 'Hroch', 'Western gorilla': 'Gorila západná',
    'Cheetah': 'Gepard', 'Leopard': 'Leopard', 'African buffalo': 'Byvol africký',
    'Spotted hyena': 'Hyena škvrnitá', 'Meerkat': 'Surikata', 'African wild dog': 'Pes hyenovitý',
    'Mandrill': 'Mandril', 'Black rhinoceros': 'Nosorožec čierny', 'Nile crocodile': 'Krokodíl nílsky',
    'Common ostrich': 'Pštros africký', 'Greater flamingo': 'Plameniak ružový',
    'Warthog': 'Prasa bradavičnaté', 'Blue wildebeest': 'Pakôň modrý',
    'Springbok': 'Springbok', 'Aardvark': 'Hrabáč', 'Okapi': 'Okapi',
    'Shoebill': 'Člnozobec kráľovský', 'African penguin': 'Tučniak okuliarnatý',
    'Honey badger': 'Medojed kapský', 'Caracal': 'Karakal', 'Serval': 'Serval',
    'Secretary bird': 'Sekretár hadiar', 'Gerenuk': 'Gerenuk', 'Impala': 'Impala',
    'African fish eagle': 'Orliak africký', 'African grey parrot': 'Papagáj sivý',
    'Bongo antelope': 'Bongo', 'Greater kudu': 'Kudu veľký', 'Common eland': 'Antilopa losovia',
    'Gemsbok': 'Prímorožec juhoafrický', 'Sable antelope': 'Antilopa vraná',
    'Topi': 'Topi', 'Red hartebeest': 'Bubal červený',
    "Kirk's dik-dik": 'Dikdik Kirkov', 'African civet': 'Cibetka africká',
    'Common genet': 'Ženetka obyčajná', 'Rock hyrax': 'Daman skalný',
    'Cape porcupine': 'Dikobraz juhoafrický', 'Yellow mongoose': 'Mangusta žltá',
    'African clawless otter': 'Vydra bezpazúrová', 'Marabou stork': 'Marabu africký',
    'Kori bustard': 'Drop obrovský', 'Bateleur': 'Bateleur',
    'Saddle-billed stork': 'Bocian sedlový', 'Lilac-breasted roller': 'Krakľa obrátená',
    'Ground pangolin': 'Luskáň stepný', 'Lappet-faced vulture': 'Sup ušatý',
    'African wild cat': 'Mačka púštna', 'Nile monitor': 'Varan nílsky',
    'Pygmy hippopotamus': 'Hroch libérijský', 'White rhinoceros': 'Nosorožec biely',
    'African forest elephant': 'Slon pralesný', 'Bonobo': 'Bonobo',
    'Common chimpanzee': 'Šimpanz učenlivý', 'Olive baboon': 'Pavián anubi',
    'Nile tilapia': 'Tilapia nílska', 'African bullfrog': 'Žaba africká',
    'Puff adder': 'Vretenica puffovitá', 'Black mamba': 'Mamba čierna',
    'Gelada': 'Dželada', 'Great white shark': 'Žralok biely',
    'Hammerhead shark': 'Žralok kladivohlavý',

    // ASIA
    'Bengal tiger': 'Tiger bengálsky', 'Giant panda': 'Panda veľká',
    'Asian elephant': 'Slon ázijský', 'Snow leopard': 'Leopard snežný',
    'Komodo dragon': 'Varan komodský', 'King cobra': 'Kobra kráľovská',
    'Orangutan': 'Orangutan', 'Proboscis monkey': 'Opica nosatá',
    'Indian rhinoceros': 'Nosorožec indický', 'Red panda': 'Panda červená',
    'Japanese macaque': 'Makak japonský', 'Indian peafowl': 'Páv korunkatý',
    'Binturong': 'Binturong', 'Sun bear': 'Medveď malajský',
    'Malayan tapir': 'Tapír čabrakový', 'Gharial': 'Gaviál indický',
    'Mandarin duck': 'Kačica mandarínska', 'Siamang': 'Siamang',
    'Bactrian camel': 'Ťava dvojhrbá', 'Saiga antelope': 'Sajga tatárska',
    'Markhor': 'Markhor', 'Yak': 'Jak', "Pallas's cat": 'Mačka Pallasova',
    'Clouded leopard': 'Leopard dymový', 'Babirusa': 'Babirusa',
    'Slow loris': 'Lori váhavý', 'Saltwater crocodile': 'Krokodíl morský',
    'Flying lemur': 'Letucha', 'Tarsier': 'Nártoun', 'Draco lizard': 'Lietavec',
    'Amur leopard': 'Leopard amurský', 'Asian black bear': 'Medveď ušatý',
    'Dhole': 'Dhol', 'Fishing cat': 'Mačka rybárska',
    'Irrawaddy dolphin': 'Delfín iravadský', 'Dugong': 'Dugong',
    'Asian small-clawed otter': 'Vydra malá', 'Indian flying fox': 'Kalóň indický',
    'Golden snub-nosed monkey': 'Opica zlatá', 'Tibetan fox': 'Líška tibetská',
    'Tibetan antelope': 'Antilopa tibetská', 'Kiang': 'Kiang',
    'Himalayan tahr': 'Tahr himalájsky', 'Gaur': 'Gaur',
    'Chinese alligator': 'Aligátor čínsky', 'Indian python': 'Pytón indický',
    'Reticulated python': 'Pytón sieťovaný', 'Javan rhinoceros': 'Nosorožec jávsky',
    'Sumatran rhinoceros': 'Nosorožec sumatriansky',
    'Pig-tailed macaque': 'Makak veprovitý', 'Lar gibbon': 'Gibbon bielodlaný',
    'Bornean orangutan': 'Orangutan bornejský', 'Sumatran tiger': 'Tiger sumatriansky',
    'Greater one-horned rhinoceros': 'Nosorožec indický',
    'Asian water buffalo': 'Byvol vodný',
    'Giant ibis': 'Ibis obrovský', 'Bali myna': 'Škorec balský',
    'Sunda pangolin': 'Luskáň jávsky', 'Pygmy slow loris': 'Lori trpasličí',
    'Indian star tortoise': 'Korytnačka hviezdnatá',
    'Whale shark': 'Žralok veľrybí', 'Manta ray': 'Manta obrovská',
    'Lionfish': 'Perutýn ohnivý',

    // EUROPE
    'Brown bear': 'Medveď hnedý', 'European bison': 'Zubor európsky',
    'Grey wolf': 'Vlk dravý', 'Eurasian lynx': 'Rys ostrovid',
    'Wild boar': 'Diviak lesný', 'Red fox': 'Líška hrdzavá',
    'Roe deer': 'Srnec hôrny', 'European beaver': 'Bobor európsky',
    'White stork': 'Bocian biely', 'Barn owl': 'Plamienka driemavá',
    'Eurasian eagle-owl': 'Výr skalný', 'Atlantic puffin': 'Papuchalk severný',
    'Dalmatian pelican': 'Pelikán kučeravý', 'European hedgehog': 'Ježko západný',
    'Alpine ibex': 'Kozorožec alpský', 'Chamois': 'Kamzík vrchovský',
    'European otter': 'Vydra riečna', 'Wolverine': 'Rosomák sibirský',
    'European mink': 'Norok európsky', 'Mouflon': 'Muflón lesný',
    'Red deer': 'Jeleň lesný', 'Fallow deer': 'Daniel škvrnitý',
    'Reindeer': 'Sob polárny', 'Arctic fox': 'Polárna líška',
    'Golden eagle': 'Orol skalný', 'White-tailed eagle': 'Orliak morský',
    'Peregrine falcon': 'Sokol sťahovavý', 'Common kingfisher': 'Rybárik riečny',
    'European bee-eater': 'Včelárik zlatý', 'Hoopoe': 'Dudok chochlatý',
    'Common crane': 'Žeriav popolavý', 'Eurasian spoonbill': 'Lyžičiar biely',
    'European badger': 'Jazvec lesný', 'Stone marten': 'Kuna skalná',
    'European polecat': 'Tchor tmavý', 'Eurasian water vole': 'Hryzec vodný',
    'European ground squirrel': 'Syseľ pasienkový', 'Common kestrel': 'Sokol myšiar',
    'Black stork': 'Bocian čierny', 'Great grey owl': 'Sova dlhochvostá',
    'Bottlenose dolphin': 'Delfín skáčúci',
    'Loggerhead sea turtle': 'Korytnačka obyčajná',
    'Mediterranean monk seal': 'Tuleň stredomorský',
    'Common octopus': 'Chobotnica obyčajná', 'Common seal': 'Tuleň obyčajný',

    // NORTH AMERICA
    'Grizzly bear': 'Medveď grizly', 'American bison': 'Bizón americký',
    'Moose': 'Los mokraďový', 'White-tailed deer': 'Jeleň bielochvostý',
    'Bald eagle': 'Orol bielohlavý', 'American alligator': 'Aligátor americký',
    'Cougar': 'Puma', 'American black bear': 'Medveď baribal',
    'American pronghorn': 'Vidloroh americký', 'California condor': 'Kondor kalifornský',
    'North American river otter': 'Vydra severoamerická',
    'Wild turkey': 'Moriak divý', 'Striped skunk': 'Skunk pruhovaný',
    'Virginia opossum': 'Opossum virginský', 'American beaver': 'Bobor americký',
    'Common raccoon': 'Medvedík čistotný',
    'Black-tailed prairie dog': 'Psotvár čiernochrbtý',
    'Nine-banded armadillo': 'Pásavec deväťpásový', 'Sea otter': 'Vydra morská',
    'Northern elephant seal': 'Uškatec severný', 'Snowy owl': 'Sova snežná',
    'American badger': 'Jazvec americký', 'Bobcat': 'Rys červený',
    'Canada lynx': 'Rys kanadský', 'Polar bear': 'Medveď polárny',
    'Musk ox': 'Pižmoň severný', 'Caribou': 'Karibu',
    'Walrus': 'Mrož', 'Harbor seal': 'Tuleň obyčajný',
    'Steller sea lion': 'Uškatec Stellerov', 'American mink': 'Norok americký',
    'Whooping crane': 'Žeriav trúbiaci', 'Sandhill crane': 'Žeriav kanádsky',
    'Great blue heron': 'Volavka veľká', 'Roseate spoonbill': 'Lyžičiar ružový',
    'Wood duck': 'Kačica lesná', 'American pika': 'Pišťucha americká',
    'Mountain goat': 'Koza snežná', 'Bighorn sheep': 'Ovca tlstorozá',
    'Eastern box turtle': 'Korytnačka škatuľová',
    'American bullfrog': 'Ropucha volacia', 'Northern mockingbird': 'Drozdec mnohohranný',
    'Ruby-throated hummingbird': 'Kolibrík rubínohrdlý',
    'Sperm whale': 'Vorváň obrovský', 'Narwhal': 'Narval',
    'Beluga whale': 'Beluga', 'Giant Pacific octopus': 'Chobotnica obrovská',

    // SOUTH AMERICA
    'Jaguar': 'Jaguár', 'Capybara': 'Kapybara',
    'South American tapir': 'Tapír juhoamerický', 'Llama': 'Lama',
    'Giant anteater': 'Mravčiar veľký', 'Pale-throated sloth': 'Leňochod trojprstý',
    'Green anaconda': 'Anakonda zelená', 'Harpy eagle': 'Orol harpyja',
    'Toco toucan': 'Tukan veľký', 'Giant armadillo': 'Pásavec obrovský',
    'Maned wolf': 'Vlk hrivnatý', 'Giant river otter': 'Vydra obrovská',
    'Spectacled bear': 'Medveď okuliarnatý', 'Ocelot': 'Ocelot',
    'Alpaca': 'Alpaka', 'Amazon river dolphin': 'Delfín ríečny amazónsky',
    'Red-bellied piranha': 'Piraňa červenobruchá', 'Arapaima': 'Arapaima',
    'Guanaco': 'Guanako', 'Viscacha': 'Vizkača',
    'Patagonian mara': 'Mara patagónska', 'South American coati': 'Nosáľ červený',
    'Pampas deer': 'Jeleň pampový', 'Marsh deer': 'Jeleň močiarový',
    'Poison dart frog': 'Jedovatá šípová žaba',
    'Andean condor': 'Kondor andský', 'Jabiru': 'Žabirú americký',
    'Scarlet macaw': 'Ara arakanga', 'Blue-and-yellow macaw': 'Ara ararauna',
    'Hyacinth macaw': 'Ara hyacintový', 'Hoatzin': 'Hoatzin',
    'Sunbittern': 'Slnečnica', 'Scarlet ibis': 'Ibis červený',
    'Andean flamingo': 'Plameniak andský', 'Chilean flamingo': 'Plameniak čilský',
    'Black-necked swan': 'Labuť čiernokrká', "Darwin's rhea": 'Nandu Darwinov',
    'Mountain tapir': 'Tapír horský', 'Giant toad': 'Ropucha obrovská',
    'Glass frog': 'Sklenená žaba', 'Matamata': 'Matamata',
    'South American sea lion': 'Lachtan juhoamerický', 'Boto': 'Boto',
    'Piranha': 'Piraňa', 'Leatherback sea turtle': 'Korytnačka kožatá',

    // AUSTRALIA
    'Red kangaroo': 'Klokan červený', 'Koala': 'Koala',
    'Common wombat': 'Vombat štíhly', 'Tasmanian devil': 'Diabol tasmánsky',
    'Platypus': 'Vtákopysk', 'Short-beaked echidna': 'Ježura krátkozobá',
    'Laughing kookaburra': 'Kukabura chocholatá', 'Emu': 'Emu',
    'Southern cassowary': 'Kazuár prilbový', 'Thorny devil': 'Moloch ostnatý',
    'Frilled-neck lizard': 'Jašter goliernatý', 'Quokka': 'Kvoka',
    'Numbat': 'Numbat', 'Sugar glider': 'Vakoveverica lietavá',
    'Dingo': 'Dingo', 'Wedge-tailed eagle': 'Orol klinochvostý',
    'Bilby': 'Bilbi', 'Quoll': 'Kunovček', 'Eastern grey kangaroo': 'Klokan sivý',
    'Tree kangaroo': 'Klokan stromový',
    'Wallaby': 'Valabi', 'Common brushtail possum': 'Kusus líščí',
    'Common ringtail possum': 'Kusus krúžkochvostý',
    'Eastern quoll': 'Kunovček východný', 'Spotted-tailed quoll': 'Kunovček škvrnitý',
    'Tawny frogmouth': 'Lelkúň hnedý', 'Brolga': 'Brolga',
    'Australian pelican': 'Pelikán austrálsky',
    'Sulphur-crested cockatoo': 'Kakadu žltkasý', 'Australian magpie': 'Straka austrálska',
    'Galah': 'Kakadu ružový', 'Superb fairywren': 'Modrovrábok nádherný',
    'Kakapo': 'Kakapo', 'Kiwi': 'Kivi', 'Tuatara': 'Hatéria',
    'Green sea turtle': 'Korytnačka zelená', 'Clownfish': 'Klaun očkavý',

    // ANTARCTICA
    'Emperor penguin': 'Tučniak cisársky', 'King penguin': 'Tučniak kráľovský',
    'Chinstrap penguin': 'Tučniak uzdičkový', 'Gentoo penguin': 'Tučniak oslí',
    'Adélie penguin': 'Tučniak krotkavý', 'Macaroni penguin': 'Tučniak zlatochocholý',
    'Leopard seal': 'Tuleň leopardí', 'Weddell seal': 'Tuleň Weddellov',
    'Crabeater seal': 'Tuleň krabožravý', 'Antarctic fur seal': 'Uškatec antarktický',
    'Southern elephant seal': 'Uškatec južný', 'Snow petrel': 'Víchrovník snežný',
    'South Polar skua': 'Pomorník južný',

    // OCEAN / MARINE
    'Orca': 'Kosatka dravá', 'Humpback whale': 'Vráskavcovitá veľryba',
    'Blue whale': 'Veľryba modrá',
  };
  ...
  async function run(onProgress, onDone, onError) {
    ...
    for (let i = 0; i < rawAnimals.length; i += BATCH) {
      ...
      await Promise.all(batch.map(async raw => {
        // Slovak name: prefer Wikidata label, then hardcoded NAME_SK, then translation API
        let label = raw.wikidataQid ? skLabels.get(raw.wikidataQid) : null;
        if (!label) {
          label = NAME_SK[raw.seed.name] || await translateText(raw.seed.name, sessionEmail);
        }
